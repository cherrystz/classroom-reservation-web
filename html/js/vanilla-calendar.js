/*
    ...
    License: http://www.opensource.org/licenses/mit-license.php
     <!-- More about api : https://www.cssscript.com/filterable-calendar-vanilla/ -->
*/
    ...
    function VanillaCalendar(options) {
        ...
        const createCalendar = function () {
            ...
            <div class="vanilla-calendar-header">
                <button type="button" class="vanilla-calendar-btn" data-calendar-toggle="previous"><i class="fas fa-chevron-left"></i></button>
